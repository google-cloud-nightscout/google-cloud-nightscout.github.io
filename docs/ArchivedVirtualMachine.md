---
title: "Archived Google Cloud Virtual Machine for Nightscout"
description: "Archived Step-by-step manual instructions to create a free-tier Google Cloud virtual machine optimized for hosting Nightscout safely and efficiently."
---

This page is only maintained as an archive.  
The prefered updated guide for creating a virtual machine is [here](./VirtualMachine.md).  
  
# Google Cloud Virtual Machine (Old manual method)  
