...
[Google Cloud Nightscout](../) >> [FAQ](./GCNS/FAQ.md) >> What is my Hostname, API_SECRET, FreeDNS ID or password?  
...
You will be taken to a page where you can see all of those assuming you have completed [installation](../).  An example is shown below.  
